...
4. [Download this repository](../../archive/refs/heads/main.zip) and extract the startup batch files as well as the t7x and zone folders to the UnrankedServer Folder
...
Copy common fastfiles that are needed for zombies.

```
zone/en_zm_common.fd
